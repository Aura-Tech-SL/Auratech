    ...
    const blocks = [
      ...
      },
      {
        ...
        data: {
          ...
          tiers: [
            { name: c.pricing.tier1.name, price: "149", period: c.pricing.period, features: c.pricing.tier1.features, ctaText: c.pricing.tier1.cta, ctaLink: `${contactBase}+(Starter)`, highlighted: false },
            { name: c.pricing.tier2.name, price: "249", period: c.pricing.period, features: c.pricing.tier2.features, ctaText: c.pricing.tier2.cta, ctaLink: `${contactBase}+(Pro)`, highlighted: true },
            { name: c.pricing.tier3.name, price: "399", period: c.pricing.period, features: c.pricing.tier3.features, ctaText: c.pricing.tier3.cta, ctaLink: `${contactBase}+(Clinic)`, highlighted: false },
          ],
        },
      },
      {
